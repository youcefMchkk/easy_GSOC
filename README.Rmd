...
## the task
install packages `iotables` and `ioanalysis`; take one table from `iotables` as an example and run the economic analysis available in `ioanalysis`; install package `igraph` and use it to obtain the centrality measures for the network from this example table.
